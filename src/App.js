...
function App() {
  ...
  const [products, setProducts] = useState([
    ...
    {id: 4, name: 'Product 4', price: 2, stock: 17, image: RG, quantity: '' },
    {id: 5, name: 'Product 5', price: 8, stock: 19, image: GreyGame, quantity: '' },
    {id: 6, name: 'Product 6', price: 10, stock: 10, image: GameBleu, quantity: '' }
  ]);
        ...
        <div className='ALL'>
            ...
            <div className='SHOP-ALL'>
                ...
                <div className='SHOP-CONTENT'>
                    <Products product={products} buyProduct={buyProduct} money={money}/>
                </div>
            </div>
